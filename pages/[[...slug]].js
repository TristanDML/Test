...
export async function getStaticProps({ locale, locales, params, preview = false }) {
  ...
  let sbParams = {
    ...
    resolve_relations: ["directors", "writers","stars","studios","genres","newsitems","body","movies","personalities","categories", "nationality", "agerating","character","game","genre_game"],
    language: locale,
  }
